...
class ConfirmOrResendOTP extends Component {
        ...
        return (
            <View style={styles.container}>
                <ImageBackground source={{ uri: 'https://d2v9y0dukr6mq2.cloudfront.net/video/thumbnail/yI9FRzo/animated-collapsing-crumbling-wall-of-white-boxes-with-reflective-surface-2-transparent-background-alpha-channel-embedded-with-hd-png-file-good-for-video-transition-or-similar-effects-very-easy-to-put-any-video-or-image-in-the-background_v1ie0fg7__S0000.jpg' }} style={styles.container}>
                    ...
                    <View style={{ flex: 4 }}>
                        <Text style={styles.questionHeader}>Enter Verification OTP Code</Text>
                        <TextInput
                            placeholder='Enter here'
                            placeholderTextColor='#cacaca'
                            style={styles.input}
                        />
                        <TouchableHighlight style={styles.touchableHightlight} underlayColor={'transparent'} onPress={() => navigate('ResetPassword')}>
                            <Text style={[styles.button, styles.buttonLight]}>   CONFIRM   </Text>
                        </TouchableHighlight>
                        <Text style={styles.questionHeader}>DID NOT RECEIVE OTP CODE?</Text>
                        <TouchableHighlight style={styles.touchableHightlight} underlayColor={'transparent'} onPress={this.signInOnPress}>
                            <Text style={[styles.button, styles.buttonLight]}>   SEND OTP ON CALL   </Text>
                        </TouchableHighlight>
...
export default ConfirmOrResendOTP;
